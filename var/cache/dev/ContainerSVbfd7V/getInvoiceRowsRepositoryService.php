...
// Returns the private 'App\Repository\InvoiceRowsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\InvoiceRowsRepository.php';

return $this->privates['App\\Repository\\InvoiceRowsRepository'] = new \App\Repository\InvoiceRowsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
